import { AbstractAttribute } from "@core/core/abstracts/entities/AbstractAttribute";
	...
	public draw(
		...
		for (const attributeName of attributesNames) {
			...
			if (attributeName === positionAttributeName) {
				this._context.drawArrays(this._context.TRIANGLES, 0, attribute.componentsCount);
			}
		}
	}
}
